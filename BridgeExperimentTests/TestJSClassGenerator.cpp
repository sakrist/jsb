...
TEST(JSClassGenerator, FunctionGen_void_no_args) {
    ...
    jsbridge::FunctionDescriptor desc = {"calculate", true, 0, false, true};    
    auto result = jsbridge::generateJavaScriptFunction("TestClass", desc);
...
TEST(JSClassGenerator, FunctionGen_void_args1) {
    ...
    jsbridge::FunctionDescriptor desc = {"setNumber", true, 1, false, true};    
    auto result = jsbridge::generateJavaScriptFunction("TestClass", desc);
    ASSERT_EQ(expected, result);
}
...
TEST(JSClassGenerator, FunctionGen_void_args2) {
    ...
    jsbridge::FunctionDescriptor desc = {"setNumber", true, 2, false, true};    
    auto result = jsbridge::generateJavaScriptFunction("TestClass", desc);
    ASSERT_EQ(expected, result);
}
...
TEST(JSClassGenerator, FunctionGen_int_args2) {
    ...
    jsbridge::FunctionDescriptor desc = {"setNumber", false, 2, false, true};    
    auto result = jsbridge::generateJavaScriptFunction("TestClass", desc);
    ASSERT_EQ(expected, result);
}
...
TEST(JSClassGenerator, FunctionGen_int_args0) {
    ...
    jsbridge::FunctionDescriptor desc = {"getNumber", false, 0, false, true};    
    auto result = jsbridge::generateJavaScriptFunction("TestClass", desc);
    ASSERT_EQ(expected, result);
}
...
TEST(JSClassGenerator, FunctionGen_int_args0_static) {
    ...
    jsbridge::FunctionDescriptor desc = {"random", false, 0, true, true};    
    auto result = jsbridge::generateJavaScriptFunction("TestClass", desc);
    ASSERT_EQ(expected, result);
}
...
TEST(JSClassGenerator, FunctionGen_int_args1_static) {
    ...
    jsbridge::FunctionDescriptor desc = {"random", false, 1, true, true};    
    auto result = jsbridge::generateJavaScriptFunction("TestClass", desc);
    ASSERT_EQ(expected, result);
}
...
TEST(JSClassGenerator, FunctionGen_void_args0_async_static) {
    ...
    jsbridge::FunctionDescriptor desc = {"calculateNumber", true, 0, true, false};    
    auto result = jsbridge::generateJavaScriptFunction("TestClass", desc);
    ASSERT_EQ(expected, result);
}
...
TEST(JSClassGenerator, FunctionGen_void_args1_async) {
    ...
    jsbridge::FunctionDescriptor desc = {"setNumber", true, 1, false, false};    
    auto result = jsbridge::generateJavaScriptFunction("TestClass", desc);
    ASSERT_EQ(expected, result);
}
...
TEST(JSClassGenerator, FunctionGen_int_args2_async) {
    ...
    jsbridge::FunctionDescriptor desc = {"calculateNumber", false, 2, false, false};    
    auto result = jsbridge::generateJavaScriptFunction("TestClass", desc);
    ASSERT_EQ(expected, result);
}
...
TEST(JSClassGenerator, FunctionGen_int_args0_async_static) {
    ...
    jsbridge::FunctionDescriptor desc = {"calculateNumber", false, 0, true, false};    
    auto result = jsbridge::generateJavaScriptFunction("TestClass", desc);
    ASSERT_EQ(expected, result);
}
